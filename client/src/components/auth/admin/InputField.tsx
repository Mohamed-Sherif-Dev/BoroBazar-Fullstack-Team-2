...
const AdminInputField = forwardRef<HTMLInputElement, InputFieldProps>(
  ({ label, error, showPasswordToggle, type, className, ...rest }, ref) => {
      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <div className="relative">
          <input
            ...
            type={inputType}
            className={clsx(
              "w-full rounded-md border px-3 py-2 sm:py-2.5 text-sm outline-none transition-all",
